...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set pl_irq_ef [ create_bd_port -dir I -from 0 -to 0 pl_irq_ef ]
  set pl_irq_er [ create_bd_port -dir I -from 0 -to 0 pl_irq_er ]
  set pl_irq_lh [ create_bd_port -dir I -from 0 -to 0 pl_irq_lh ]
  set pl_irq_ll [ create_bd_port -dir I -from 0 -to 0 pl_irq_ll ]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins myip_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net myip_0_slv_reg0 [get_bd_pins myip_0/slv_reg0] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net pl_irq_ef_1 [get_bd_ports pl_irq_ef] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net pl_irq_er_1 [get_bd_ports pl_irq_er] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net pl_irq_lh_1 [get_bd_ports pl_irq_lh] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net pl_irq_ll_1 [get_bd_ports pl_irq_ll] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins myip_0/s00_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlconcat_0/In5] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins myip_0/s00_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0001000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs myip_0/S00_AXI/S00_AXI_reg] SEG_myip_0_S00_AXI_reg
