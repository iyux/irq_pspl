...
HD_PWD='/2020/mpsoc/training/irq_pl/project_1/project_1.runs/Base_Zynq_MPSoC_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Base_Zynq_MPSoC_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Base_Zynq_MPSoC_xbar_0.tcl
